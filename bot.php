<?php 
define('BOT_TOKEN', '5256398874:AAFclJKLNrA08Y-Os65lHDBjvKY3TJgDzmo'); 
...
function processaCallbackQuery($callback){
  $BOT_TOKEN = "5256398874:AAFclJKLNrA08Y-Os65lHDBjvKY3TJgDzmo";
...
ID:".$id."|".$dataCerta." ".$hora,
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                  ...
                  $arquivo = file_get_contents('usuarios.txt');
                  $linhas = explode("\n", $arquivo);
                  $palavra = $id;
...
ID:".$id."|".$dataCerta." ".$hora,
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                  ...
                  $arquivo = implode("\n", $linhas);
                  file_put_contents('usuarios.txt', $arquivo);                    
...
Chat-id: -".$comando."|".$dataCerta." ".$hora,
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                  ...
                  $arquivo = file_get_contents('grupos.txt');
                  $linhas = explode("\n", $arquivo);
                  $palavra = $comando;
                  foreach($linhas as $linha => $valor) {
                      $posicao = preg_match("/\b$palavra\b/i", $valor);                      
...
Chat-id: -".$comando."|".$dataCerta." ".$hora,
     'reply_markup' => array('inline_keyboard' => array(                                                                                                                                                    
                  ...
                  $arquivo = implode("\n", $linhas);
                  file_put_contents('grupos.txt', $arquivo);                    
       ...
       if(strpos($text, "/lista") === 0) {
            ...
            if ($user_id == $adm) {
                ...
                $lista = file_get_contents('usuarios.txt');
...
define('WEBHOOK_URL', 'https://hgconsultabot.herokuapp.com/bot.php');
